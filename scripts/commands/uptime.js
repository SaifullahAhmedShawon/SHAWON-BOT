...
registerFont(__dirname + `/nayan/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    ctx.fillText("@" + "https://www.facebook.com/profile.php?id=100028225931329&mibextid=ZbWKwL", 250, 515)
    ctx.fillText("@" + "SAIFULLAH AHMED SHAWON", 250, 575)
